...
const createPackageBooking = asyncHandler(async (req, res) => success(res, "Package booking created successfully", await service.createPackageBooking(req.user, req.body), 201));
const createHotelBooking = asyncHandler(async (req, res) => success(res, "Hotel booking created successfully", await service.createHotelBooking(req.user, req.body), 201));
const createVehicleBooking = asyncHandler(async (req, res) => success(res, "Vehicle booking created successfully", await service.createVehicleBooking(req.user, req.body), 201));
